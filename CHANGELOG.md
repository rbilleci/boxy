...
|------|--------|-------------|--------|
| 2026-03-02 | 160-167 | Section 15: Core enhancements — sp_topics__resize_partitions, sp_topics__cache_invalidate, sp_subscriptions__subscribe_v4 (start from watermark/position-0), docs/lease-distribution.md (Hamilton apportionment), docs/evaluations/ (async-jdbc, goharvest, bento-patterns, mysql-jdbc-tuning) | 5536ae5 |
| 2026-03-02 | 154-159 | Section 14: Client SDKs — Worker/Consumer API (Worker, WorkerConfig, EventHandler, WorkerMetrics with thread pool + back-pressure + Micrometer), sdk scaffolds for Go/Python/Rust/.NET/JavaScript | 5536ae5 |
| 2026-03-02 | 150-153 | Section 13: Branch hygiene — docs/release-process.md, scripts/cleanup-stale-branches.sh, .github/branch-protection.md, .github/workflows/release.yml (GitHub Releases automation) | 5536ae5 |
| 2026-03-02 | 146-149 | Section 12: Packaging — root pom.xml metadata (name/description/license/scm/developers), Maven Central + GitHub Packages distribution config, GPG signing plugin, Maven staging plugin, docker/ evaluation environment (Dockerfile + docker-compose), docs/release-process.md | 5536ae5 |
| 2026-03-02 | 138-145 | Section 11: Docs & DX — docs/runbook.md (scaling/monitoring/troubleshooting), docs/retention.md (cleanup examples), docs/tuning.md (3 workload profiles), docs/stored-procedures.md (full SP reference), docs/quickstart.md (producer/consumer examples), docs/adr/ (5 ADRs: SP protocol, partition encoding, lease model, JSON args, versioned SPs), Javadoc on all domain records | f3984cb |
...
| Section 12: Packaging | 4 | 4 | 0 |
| Section 13: Branch Hygiene | 4 | 4 | 0 |
| Section 14: Client SDKs | 6 | 6 | 0 |
| Section 15: Core Enhancements | 8 | 8 | 0 |
| **TOTAL** | **167** | **167** | **0** |
