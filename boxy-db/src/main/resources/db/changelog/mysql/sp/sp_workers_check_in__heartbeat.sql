...
BEGIN
    ...
    INSERT INTO workers (
        node_id, consumer_group_id, weight, last_heartbeat, heartbeat_interval, heartbeat_deadline)
    VALUES (
        p_node_id, p_consumer_group_id, p_weight, CURRENT_TIMESTAMP(3), p_heartbeat_interval, p_heartbeat_deadline)
