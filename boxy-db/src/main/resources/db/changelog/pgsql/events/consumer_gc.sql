...
CREATE OR REPLACE FUNCTION sp_consumers__gc__run()
    LANGUAGE plpgsql
AS $$
DECLARE
...
BEGIN
    ...
    EXCEPTION WHEN OTHERS THEN
        ...
        VALUES ('consumer_gc', SQLSTATE, SQLERRM, CURRENT_TIMESTAMP(3));
        RAISE;
    END;
END;
$$;
